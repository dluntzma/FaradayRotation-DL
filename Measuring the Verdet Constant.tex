...
We measured the intensity of a laser propagating through XXXX in a magnetic field while rotating a polarizing lens or varying a magnetic field.  We observed Faraday Rotation both cases and measured the Verdet  constant of the XXXXX rod to be 19.5 $\pm$0.9 $\frac{1}{Tm}$ and 19.12 $\pm$0.05 $\frac{1}{Tm}$.
