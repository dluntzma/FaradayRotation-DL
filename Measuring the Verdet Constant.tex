...
From the measurements at 45$^{\circ}$ relative angle while changing magnetic field, for currents from -3A to 3A in steps of 0.5A, we obtained the results shown in Table ~\ref{V_I_Table}. 
